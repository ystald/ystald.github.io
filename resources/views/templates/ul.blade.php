...
@section('container')
    ...
    <div class="Landscape">
        ...
        <p>
            <strong>Юридического лица</strong>
        </p>

        <table class="MsoTableGrid" border=1 cellspacing=0 cellpadding=3>
            <tr>
                <td width="40">1</td>
                <td width="45%">Организационно-правовая форма (ОПФ)</td>
                <td width="50%">{{ $data->opf }}</td>
            </tr>
            <tr>
                <td>2</td>
                <td>Наименование юридического лица без ОПФ</td>
                <td>{{ $data->org_name }}</td>
            </tr>
            <tr>
                <td>3</td>
                <td>Полное наименование юридического лица</td>
                <td>{{ $data->opf }} {{ $data->org_name }}</td>
            </tr>
            <tr>
                <td>4</td>
                <td>ИНН</td>
            ...
            <tr>
                <td>7</td>
                <td>Должность руководителя организации</td>
                <td>{{ $data->post }}</td>
            </tr>
            <tr>
                <td>8</td>
                <td>ФИО руководителя организации</td>
                <td>{{ $data->fio }}</td>
            </tr>
            <tr>
                <td>9</td>
        ...
        <table width="100%">
            ...
            <tr>
                ...
                <td style="border-bottom: 1px solid #000;">Устава</td>
            </tr>
            <tr>
                <td></td>
                <td align="center">
                    <small>(Устава, Положения – для юр. лиц, доверенности – для представителя)</small>
                </td>
            </tr>
        </table>
        ...
        <table>
            <tr>
                <td width="30%">
                    Руководитель юридического лица<br/>
